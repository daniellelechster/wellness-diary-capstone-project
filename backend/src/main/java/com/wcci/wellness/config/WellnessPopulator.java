...
public class WellnessPopulator implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        // ---------- WATER ----------
        Water water1 = new Water(5); water1.setCreatedAt(LocalDate.now().minusDays(10));
        Water water2 = new Water(8); water2.setCreatedAt(LocalDate.now().minusDays(9));
        Water water3 = new Water(4); water3.setCreatedAt(LocalDate.now().minusDays(8));
        Water water4 = new Water(7); water4.setCreatedAt(LocalDate.now().minusDays(7));
        Water water5 = new Water(6); water5.setCreatedAt(LocalDate.now().minusDays(6));
        Water water6 = new Water(3); water6.setCreatedAt(LocalDate.now().minusDays(5));
        Water water7 = new Water(9); water7.setCreatedAt(LocalDate.now().minusDays(4));
        Water water8 = new Water(2); water8.setCreatedAt(LocalDate.now().minusDays(3));
        Water water9 = new Water(5); water9.setCreatedAt(LocalDate.now().minusDays(2));
        Water water10 = new Water(7); water10.setCreatedAt(LocalDate.now().minusDays(1));
        ...
        Journal journal8 = new Journal("How did you manage stress today?", "Took breaks and practiced deep breathing.");
        Journal journal9 = new Journal("Any creative activities today?", "Doodled in my notebook.");
        Journal journal10 = new Journal("Reflection on today’s accomplishments?", "Finished all tasks on my to-do list.");
